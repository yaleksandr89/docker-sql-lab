...
первого `make up`. Если нужно сохранить собственные данные из уже
инициализированных каталогов, перед подтверждённой переинициализацией создайте
резервную копию. Точный порядок действий приведён в разделе
