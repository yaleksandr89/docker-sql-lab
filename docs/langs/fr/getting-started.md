...
données sont déjà initialisés, sauvegardez-les avant une réinitialisation
confirmée uniquement si vous devez conserver des données personnelles. Consultez la procédure exacte dans
